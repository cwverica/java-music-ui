...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/caseyverica/Documents/Java11/Music/" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_SORT = " ORDER BY " +
    ...
    public static final String QUERY_VIEW_SONG_INFO_PREP = "SELECT " + COLUMN_ARTIST_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = ?";
    // ^^ Treats placeholder "?" as single unit, no quotes used, safe from injection attacks
    // Also, preparing a statement improves performance, because it's not building the string for each use
    ...
    public void close() {
        try {
            ...
            System.out.println("Could not get connection: " + e.getMessage());
        }
    }
    ...
    public void querySongsMetadata() {
        ...
        ResultSet results = statement.executeQuery(sql)){
            ...
            System.out.println("Query failes: " + e.getMessage());
        }
    }
...
//            System.out.format("Count = %d, Min = %d\n", count, min);
    ...
    public void insertSong(String title, String artist, String album, int track) {
        //should check to see if song exists first
        ...
        try {
            ...
            try {
                ...
                System.out.println("We're pretty f*$#ed: " + e2.getMessage());
            } finally {
                try {
